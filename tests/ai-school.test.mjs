...
assert.match(html, /name="payment_method" value="クレジットカード"[^>]*required/);
assert.match(html, /name="payment_method" value="銀行振込"/);
assert.match(html, /name="payment_method" value="当日現金"/);
...
assert.match(script, /if \(paymentMethod === 'クレジットカード'\)/);
assert.match(script, /stripePaymentButton\.href = STRIPE_PAYMENT_LINK/);
assert.match(script, /showPaymentResult\(paymentMethod\)/);
